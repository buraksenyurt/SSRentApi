    ...
    public partial class initialcreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Jupiter Ganymede", "Science Base 1" },
                    { 2, "Juipter IO", "Transfer Alpha" },
                    { 3, "Mars Phobos", "Deep Horizon" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "skati@email.com", "skati", "skati@1234" },
                    { 2, "deyna@email.com", "deyna", "deyna@1234" },
                    { 3, "data@email.com", "ddata", "data@1234" }
                });
